...
@Component({
  selector: 'app-pagedepartment',
  templateUrl: './pagedepartment.component.html',
  styleUrls: ['./pagedepartment.component.css']
})
export class PagedepartmentComponent implements OnInit {
  @Input()
